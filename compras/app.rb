...
2- No arquivo mercado.rb crie uma classe chamada Mercado que ao ser inicializada recebe como atributo um objeto 
da classe Produto.
...
Depois, inicie uma instância da classe Mercado passando um objeto produto como atributo e para finalizar execute 
o método comprar.
=end
...
produto.nome = 'Papel 300g/m²'
produto.preco = 23.10

Mercado.new(produto.nome, produto.preco).compra
